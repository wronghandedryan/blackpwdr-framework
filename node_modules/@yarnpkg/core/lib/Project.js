...
class Project {
    ...
    static async find(configuration, startingCwd) {
        ...
        throw new clipanion_1.UsageError(`The nearest package directory (${configuration.format(packageCwd, Configuration_1.FormatType.PATH)}) doesn't seem to be part of the project declared in ${configuration.format(project.cwd, Configuration_1.FormatType.PATH)}.\n\n- If the project directory is right, it might be that you forgot to list ${configuration.format(fslib_1.ppath.relative(project.cwd, packageCwd), Configuration_1.FormatType.PATH)} as a workspace.\n- If it isn't, it's likely because you have a yarn.lock or package.json file there, confusing the project root detection.`);
    }
        ...
        for (const extensions of this.configuration.packageExtensions.values())
            for (const { descriptor, changes } of extensions)
                for (const change of changes)
                    (_b = Configuration_1.Configuration.telemetry) === null || _b === void 0 ? void 0 : _b.reportPackageExtension(`${structUtils.stringifyIdent(descriptor)}:${change}`);
