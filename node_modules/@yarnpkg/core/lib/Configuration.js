...
class Configuration {
    ...
    static async findProjectCwd(startingCwd, lockfileFilename) {
        ...
        while (nextCwd !== currentCwd) {
            currentCwd = nextCwd;
            if (fslib_2.xfs.existsSync(fslib_2.ppath.join(currentCwd, `package.json`)))
    ...
    static async updateConfiguration(cwd, patch) {
        ...
        await fslib_2.xfs.changeFilePromise(configurationPath, parsers_1.stringifySyml(replacement), {
