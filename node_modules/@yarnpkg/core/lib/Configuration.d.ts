...
export declare const formatColors: Map<FormatType, string> | Map<FormatType, number>;
...
export declare class Configuration {
    ...
    packageExtensions: Map<IdentHash, Array<{
    ...
    format(text: string, colorRequest: FormatType | string): any;
}
export {};
